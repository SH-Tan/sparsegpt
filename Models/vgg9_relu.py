...
def _vgg(arch, num_classes, pretrained):
    model = VGG9_CIFAR10(num_classes=num_classes)
    if pretrained:
        if num_classes == 10:
            pretrained_path = 'Models/models/new/' + 'vgg9_10_ori_relu_s2_r2.pth'
        elif num_classes == 100:
            pretrained_path = 'Models/models/new/' + 'vgg9_100_ori_relu_s2_lr2.pth'
